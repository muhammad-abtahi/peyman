...
import 'package:peyman/widgets/dialog-boxes.dart';
...
class ContractAView extends StatelessWidget {
  ...
  // Future<dynamic> successDialogBox(BuildContext context, String headerText, String infoText, String buttonText) {
  //   return showDialog(
